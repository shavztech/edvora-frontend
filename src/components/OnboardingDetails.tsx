...
export default function OnboardingDetails({ data }: OnboardingDetailsProps) {
    if (!data.onboarding) return null;

    const { syllabus, classLevel, subjects, courseType } = data.onboarding;
            ...
            <div className="max-w-4xl w-full relative z-10 animate-fade-up">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                    <div className="text-center md:text-left">
                        ...
                        <h1 className="text-4xl font-[900] text-slate-900 tracking-tight leading-none">Verified Profile</h1>
                    </div>
                    <div className="flex items-center justify-center gap-3 px-5 py-3 bg-emerald-50/50 text-emerald-700 rounded-2xl border border-emerald-100 shadow-sm backdrop-blur-sm">
                        ...
                        <span className="font-black text-[11px] uppercase tracking-widest">Active & Validated</span>
                    </div>
                </div>
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 grid gap-6 sm:grid-cols-3">
                        ...
                        <div className="bg-white p-7 rounded-[28px] shadow-[0_20px_40px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col gap-5 group hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] transition-all duration-500">
                            ...
                            <div>
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Syllabus</p>
                        ...
                        <div className="bg-white p-7 rounded-[28px] shadow-[0_20px_40px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col gap-5 group hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] transition-all duration-500">
                            ...
                            <div>
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Classroom</p>
                                <p className="text-xl font-[900] text-slate-800 capitalize tracking-tight">{classLevel}</p>
                            </div>
                        </div>

                        {/* COURSE CARD */}
                        <div className="bg-white p-7 rounded-[28px] shadow-[0_20px_40px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col gap-5 group hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] transition-all duration-500">
                            <div className="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-2xl flex items-center justify-center border border-emerald-100 group-hover:scale-110 transition-transform shadow-sm">
                                <Zap className="w-6 h-6" />
                            </div>
                            <div>
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Study Track</p>
                                <p className="text-xl font-[900] text-slate-800 capitalize tracking-tight">{courseType}</p>
                            </div>
                        </div>
                    </div>
                ...
                {/* ACTION FOOTER */}
                <div className="mt-8 p-8 bg-slate-900 rounded-[32px] shadow-2xl shadow-slate-900/10 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative group">
                    <div className="relative z-10">
                        <h3 className="text-2xl font-[900] text-white mb-2 tracking-tight">Ready to excel?</h3>
                        <p className="text-slate-400 text-sm font-medium">Your customized environment is active. Access your workspace below.</p>
                    </div>
                    <button
