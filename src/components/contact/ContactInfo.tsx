  ...
  return (
    <section className="relative overflow-hidden py-4 md:py-6 lg:py-8">
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        {/* Cards */}
        <motion.div
          className="flex flex-col md:grid md:grid-cols-2 lg:grid lg:grid-cols-3 gap-4 md:gap-3 px-4"
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-2xl flex items-center justify-center ${item.bg} ${item.textColor} group-hover:scale-110 transition-all duration-300`}
                  >
                ...
                <div className="mt-6 md:mt-auto flex items-center justify-between">
                  ...
                  <div
                    className={`w-12 h-12 rounded-2xl flex items-center justify-center ${item.textColor} group-hover:rotate-45 transition-all duration-300`}
                  >
                    <ArrowRight size={20} />
                  </div>
                </div>
        ...
        {/* Bottom CTA */}
        <div className="mt-14 md:mt-20 lg:mt-40 px-4 md:px-0">          <div className="relative overflow-hidden rounded-[36px] bg-gradient-to-r from-primary via-[#4B7CC0] to-secondary p-[1px]">
            ...
            <div className="rounded-[35px] bg-white/90 backdrop-blur-xl px-8 py-12 md:px-16 md:py-14">
              ...
              <div className="relative flex flex-col lg:flex-row items-center justify-between gap-10">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="inline-block w-24 h-24 cursor-pointer hover:scale-110 transition-transform duration-300">
                    <img
                      src="/FAQ/whatsapp.png"
                      alt="WhatsApp"
