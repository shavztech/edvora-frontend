    ...
    <section className="relative py-3 lg:py-7 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <motion.div
            className="mt-0 space-y-6 flex-1"
          ...
          <div className="relative w-full md:w-auto md:mt-0 max-w-lg hidden lg:block self-start">
            ...
            <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-navy via-primary to-[#4A7BC0] p-10 shadow-[0_30px_70px_rgba(30,58,95,.35)]">
              ...
              <div className="relative">
                ...
                <span className="inline-flex rounded-full bg-white/10 backdrop-blur-md px-5 py-2 text-white font-semibold">
                  What You'll Love
                </span>
                ...
                <h3 className="mt-6 text-3xl font-black text-white leading-tight">
                  ...
                  <span className="block text-secondary">
                    To Become An Amazing Teacher
                  </span>

                </h3>

                <p className="mt-5 text-white/80 leading-relaxed">
                  Edvora provides modern teaching tools, continuous mentoring,
                  structured lesson plans and a collaborative environment
                  where educators can truly thrive.
                </p>
